 ...
 *
 *  @param propertyName Name of property given as NSString.
 ...
 *
 *  @param errorDescription errorDescription The error description, for which you want to get the message.
 */
 ...
 *
 *  @param value value of validated property.
 *  @return NSError if any.
 */
 ...
 *
 *  @param value value of validated property.
 *  @return An NSArray of errrors if any.
 */
