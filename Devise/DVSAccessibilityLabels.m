...
NSString * const DVSAccessibilityLabelConfirmLogInButton = @"Confirm log in";
NSString * const DVSAccessibilityLabelConfirmSignUpButton = @"Confirm sign up";
